    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Button asChild className="bg-jatai-yellow hover:bg-jatai-yellow-accent text-jatai-dark-gray">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-jatai-gray absolute top-full left-0 w-full shadow-md py-4">
          <div className="container mx-auto px-4 flex flex-col space-y-4">
            <a
              href="#o-que-fazemos"
              className="text-jatai-light-gray hover:text-jatai-yellow transition-colors duration-200 py-2"
              onClick={toggleMobileMenu}
            >
              O que fazemos
            </a>
            ...
            <Button asChild className="bg-jatai-yellow hover:bg-jatai-yellow-accent text-jatai-dark-gray w-full">
