...
const Footer = () => {
  ...
  return (
    <footer className="bg-jatai-dark-gray text-white py-12" ref={elementsRef}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div className="reveal">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-jatai-light-gray hover:text-jatai-yellow transition-colors duration-200">
          ...
          <div className="reveal" style={{ animationDelay: '0.6s' }}>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:contato@jatai.ai" className="text-jatai-light-gray hover:text-jatai-yellow transition-colors duration-200">contato@jatai.ai</a>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-jatai-yellow">Telefone:</span>
                <a href="tel:+551198765432" className="text-jatai-light-gray hover:text-jatai-yellow transition-colors duration-200">+55 (11) 98765-4321</a>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-jatai-yellow">Endereço:</span>
                <span className="text-jatai-light-gray">Av. Paulista, 1000, São Paulo - SP</span>
              </li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-jatai-gray mt-12 pt-8 reveal">
