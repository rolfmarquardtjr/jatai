      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="rounded-2xl overflow-hidden shadow-lg reveal">
            <div className="bg-jatai-dark-gray p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-jatai-yellow/20 p-3 rounded-full">
                    <Phone className="w-5 h-5 text-jatai-yellow" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-jatai-yellow/20 p-3 rounded-full">
                    <MapPin className="w-5 h-5 text-jatai-yellow" />
                  </div>
                  <div>
              ...
              <div className="mt-12">
                ...
                <div className="flex gap-4">
                  <a href="#" className="text-white hover:text-jatai-yellow transition-colors duration-200">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg reveal">
            <h3 className="text-2xl font-semibold text-jatai-dark-gray mb-6">Envie sua mensagem</h3>
            
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-sm font-medium text-jatai-dark-gray block">Nome completo</label>
                  <Input 
                    id="name" 
                    name="name" 
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-medium text-jatai-dark-gray block">Email</label>
                  <Input 
                    id="email" 
                    name="email" 
                    type="email" 
              ...
              <div className="space-y-2">
                <label htmlFor="company" className="text-sm font-medium text-jatai-dark-gray block">Empresa</label>
                <Input 
                  id="company" 
                  name="company" 
              ...
              <div className="space-y-2">
                <label htmlFor="message" className="text-sm font-medium text-jatai-dark-gray block">Mensagem</label>
                <Textarea 
                  id="message" 
                  name="message" 
                  rows={4} 
              ...
              <Button 
                type="submit" 
                className="w-full bg-jatai-yellow hover:bg-jatai-yellow/90 text-jatai-dark-gray gap-2" 
